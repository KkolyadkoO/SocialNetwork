    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relationship', models.CharField(choices=[('single', 'Холост'), ('in_a-rel', 'В отношениях'), ('engaged', 'Помолвлен(а)'), ('married', 'Женат/Замужем'), ('in_love', 'Влюблен(а)'), ('complicated', 'Всё сложно')], max_length=20, verbose_name='Статус отношений')),
